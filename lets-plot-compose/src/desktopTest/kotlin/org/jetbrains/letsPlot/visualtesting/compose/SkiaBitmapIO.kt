package org.jetbrains.letsPlot.visualtesting.compose
...
object SkiaBitmapIO : ImageComparer.BitmapIO {
    ...
    override fun getReadFilePath(fileName: String): String {
        return System.getProperty("user.dir") + "/src/desktopTest/resources/expected-images/$fileName"
    }
